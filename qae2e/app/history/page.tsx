      ...
      <header className="sticky top-0 z-50 border-b border-border bg-bg-page/80 backdrop-blur-xl">
        <div className="mx-auto max-w-5xl px-6 h-[64px] flex items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <Link href={`/workspace?workspaceId=${encodeURIComponent(workspaceId)}`} className="inline-flex items-center gap-1.5 text-sm font-semibold text-amber-700 hover:bg-amber-500/10 px-3 py-1.5 rounded-md transition-colors">
